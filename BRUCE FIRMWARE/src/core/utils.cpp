...
void showDeviceInfo() {
    ...
    area.addLine("");
    // Added FarhanLabs edition and modifications attribution immediately after Vinicius credit
    area.addLine("FarhanLabs Edition");
    area.addLine("");
    area.addLine("Modifications:");
    area.addLine("• PSRAM Fix");
    area.addLine("");
    area.addLine("GitHub:");
    area.addLine("github.com/FarhanLabs1/bruce-esp32s3-st7735-psram-fix");
    area.addLine("");
    area.addLine(
